...
#
# Last built on Windows-11 64-bit, this makefile is designed to run under
# a Windows-11 Command Prompt, and makes use of DOS shell commands
#
...
#
# Configure your favorit GS emulator, and have it boot the shimmer.po
# gsplus32.exe (KEGS based GS Emulator fork by Dagen Brock)
#
# see the run rule down below, to change to whatever emu you want
#
